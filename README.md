...
- **Sanal portföy (paper trading)** — her sinyal **gerçek ETF fiyatından** kâğıt
  üzerinde alınır/satılır (komisyon dahil); öz sermaye eğrisi, kazanç oranı ve max
  drawdown panelde görünür.
- **Yerel yönetim paneli (Streamlit)** — BTC + MSTR + ETF grafikleri, BTC↔MSTR
  korelasyonu (baz riski), sinyaller, performans ve canlı ayar düzenleme.
